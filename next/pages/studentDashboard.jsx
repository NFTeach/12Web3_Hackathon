        ...
        <>
            ...
            <div className={stylesHeader.header4Div}>
                <div className={stylesHeader.frameDiv}>
                    ...
                    <img className={stylesHeader.discordIcon} alt="" src="/studentDashboard_imgs/discord.svg" />
                    </div>
            ...
            <div className={stylesFirstBlock.frameDiv}>
                <div className={stylesFirstBlock.frameDiv1}>
                    ...
                    <div className={stylesFirstBlock.frameDiv4}>
                        ...
                        <b className={stylesFirstBlock.dateB}>1 September 2022, 09:41 PM</b>
                        <b
                        ...
                        <div className={stylesFirstBlock.frameDiv7}>
                            ...
                            <div className={stylesFirstBlock.completedDiv1}>76% Completed</div>
                            <img
                        ...
                        <div className={stylesFirstBlock.frameDiv8}>
                            <div className={stylesFirstBlock.completedDiv2}>29% Completed</div>
                        ...
                        <div className={stylesFirstBlock.frameDiv9}>
                            <img className={stylesFirstBlock.nFT2Icon} alt="Best Student 1" src="/studentDashboard_imgs/bestStudent1.png" />
                            <div className={stylesFirstBlock.bestStudentDiv}>Best Student</div>
                        </div>
                        <div className={stylesFirstBlock.frameDiv10}>
                            <img className={stylesFirstBlock.nFT2Icon} alt="Best Student 2" src="/studentDashboard_imgs/bestStudent2.png" />
                            <div className={stylesFirstBlock.bestStudentDiv}>Best Student</div>
                        </div>
                        </div>
                    </div>
                    ...
                    <div className={stylesFirstBlock.suggestedDiv}>
                        ...
                        <div className={stylesFirstBlock.understandingBitcoinDiv}>Math 102</div>
                    ...
                    <div className={stylesFirstBlock.leaderboardsDiv}>
                        <img className={stylesFirstBlock.areaIcon} alt="" src="/studentDashboard_imgs/area.svg" />
                        ...
                        <div className={stylesFirstBlock.topStudentsDiv}>Top Students</div>
                        <img
                            className={stylesFirstBlock.dividerLineHorizontal2}
                            alt=""
                            src="/studentDashboard_imgs/line.svg"
                        ...
                        <div className={stylesFirstBlock.controlsCheckboxActive}>
                            <img className={stylesFirstBlock.circleIcon} alt="" src="/studentDashboard_imgs/circle.svg" />
