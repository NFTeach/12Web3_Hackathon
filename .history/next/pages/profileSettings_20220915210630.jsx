    ...
    return (
        ...
        <div className={styles.headerProfileSettings}>
            <div className={styles.frameDiv}>
                <h2 className={styles.nFTeachH2}>NFTeach</h2>
                <div className={styles.tabsDiv}>
                <button className={styles.studentDashboardButton} onClick={onStudentDashboardButtonClick}>
                    Student Dashboard
                </button>
                <button className={styles.studentDashboardButton} onClick={onExploreButtonClick}>Explore</button>
                <button className={styles.studentDashboardButton} onClick={onEducatorDashboardButtonClick}>
                    Educator Dashboard
                </button>
                </div>
                <div className={styles.profilePictureDiv}>
                <img
                    className={styles.displayedNFTIcon}
                    alt="profilePFP"
                    src={pfp ? pfp : defaultImgs[0]}
                />
                <button className={styles.nameButton}>{user?.attributes.username.slice(0, 15)} </button>
                </div>
            </div>
        </div>

        {/* <div className={stylesHeader.header3Div}>
            <div className={stylesHeader.frameDiv}>
                <div className={stylesHeader.frameDiv1}>
                <h2 className={stylesHeader.textH2}>NFTeach</h2>
                <img className={stylesHeader.discordIcon} alt="" src="/profileSettings_imgs/discord.svg" />
                </div>
                <div className={stylesHeader.tabsDiv}>
                <button className={
                    stylesHeader.studentDashboardButton}
