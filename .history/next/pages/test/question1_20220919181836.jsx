                ...
                <div className={stylesFirstBlock.frameDiv4}>
                    ...
                    <RadioGroup onChange={setSelectedAnswer} value={selectedAnswer}>
                        ...
                        <div className={stylesFirstBlock.frameDiv8}>
                            ...
                            <Radio colorScheme="green" selectedAnswer={shuffledAnswerArr[0]}/>
                            <Radio colorScheme="green" selectedAnswer={shuffledAnswerArr[1]}/>
                            <Radio colorScheme="green" selectedAnswer={shuffledAnswerArr[2]}/>
                            <Radio colorScheme="green" selectedAnswer={shuffledAnswerArr[3]}/>
                            </div>
                        </div>
                        </Stack>
                    </RadioGroup>
