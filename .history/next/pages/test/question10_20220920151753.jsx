...
const question10 = (props) => {
    ...
    const validateStudent = async (tokenId) => {
        let studentAccount = user.attributes.accounts[0];
        let tokenId = JSON.stringify(tokenId);
        console.log("tokenId", tokenId);
    }
    validateStudent();
        ...
        <>
            ...
            <Modal isOpen={isOpen} onClose={onClose}>
                ...
                <ModalContent>
                    ...
                    {pass ? (
                        <ModalBody>
                            Congrats! You passed the test with a grade of {correctAnswerCount}/10!
                            <br />
                            <br />
                            <Button 
                                colorScheme="green" 
                        ...
                        <ModalBody>
                            Sorry, you did not pass the test with a grade of {correctAnswerCount}/10!
                            <br />
                            <br />
                            <Button 
                                colorScheme="green" 
