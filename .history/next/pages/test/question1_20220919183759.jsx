...
const question1 = (props) => {
    ...
    var shuffledAnswerArr = answerArr.sort(() => Math.random() - 0.5);

    console.log(shuffledAnswerArr, selectedAnswer);
        ...
        <div className={stylesFirstBlock.testPageDiv}>
            <div className={stylesFirstBlock.frameDiv}>
                ...
                <div className={stylesFirstBlock.frameDiv4}>
                    ...
                    <RadioGroup onChange={setSelectedAnswer} value={selectedAnswer} isDisabled={true}>
