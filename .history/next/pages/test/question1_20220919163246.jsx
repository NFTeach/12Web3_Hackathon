...
const question1 = (props) => {
    ...
    useEffect (async () => {
        ...
        setQuestion1(test?.question1);
        setQuestion1Answer(test?.question1Answer);
        setFakeQuestion1Answer1(test?.fakeQuestion1Answer1);
        setFakeQuestion1Answer2(test?.fakeQuestion1Answer2);
        setFakeQuestion1Answer3(test?.fakeQuestion1Answer3);
    }, []);

    console.log(question1, question1Answer, fakeQuestion1Answer1, fakeQuestion1Answer2, fakeQuestion1Answer3);
    // const answerArr = [
