      ...
      <div className={stylesFirstBlock.courseDiv}>
        <div className={stylesFirstBlock.frameDiv}>
          <div className={stylesFirstBlock.frameDiv1}>
            <Menu className={stylesFirstBlock.dropdownDefaultMenu} onChange={(e) => setSelectedSection(e.target.value)}>
              <MenuButton as={Button} colorScheme='green' >
                Change Section
              </MenuButton>
              <MenuList>
                <MenuItem value='1'>{courseSection1?.sectionName}</MenuItem>
                <MenuItem value='2'>{courseSection2?.sectionName}</MenuItem>
                <MenuItem value='3'>{courseSection3?.sectionName}</MenuItem>
              </MenuList>
            </Menu>
