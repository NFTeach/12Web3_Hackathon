...
const course = (props) => {
    ...
    useEffect (async () => {
        ...
        setCourseDescription(course[0].get("courseDescription"));
        ...
        <>
          <div className={stylesFirstBlock.courseDiv}>
            <div className={stylesFirstBlock.frameDiv}>
                ...
                <Select placeholder="Section 1" vairant="filled" bg="green" borderColor="green" color="white" onChange={(e) => setSelectedSection(e.target.value)}>
