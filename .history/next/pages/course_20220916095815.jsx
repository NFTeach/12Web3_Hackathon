...
const course = (props) => {
    ...
    const courseSection1Name= courseSection1?.get("sectionName");
    const courseSection2Name= courseSection2?.get("sectionName");
    const courseSection3Name= courseSection3?.get("sectionName");
