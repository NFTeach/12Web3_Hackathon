        ...
        <>
          <div className={stylesFirstBlock.courseDiv}>
            <div className={stylesFirstBlock.frameDiv}>
                ...
                <Select placeholder={courseSection`${selectedSection}`?.sectionName} vairant="filled" bg="green" borderColor="green" color="white" onChange={(e) => setSelectedSection(e.target.value)}>
