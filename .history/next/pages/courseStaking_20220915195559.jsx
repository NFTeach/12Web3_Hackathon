...
const courseStaking = () => {
    ...
    const approveERC20 = async () => {
        ...
        const contract = new web3.eth.Contract(NFTEACH_ERC20_CONTRACT_ABI, WMATIC_ADDRESS);
        const approve = await contract.methods.approve(GOVERNOR_CONTRACT_ADDRESS, Moralis.Units.ETH(0.0001)).send({ from: address });
            ...
            <div className={stylesFirstBlock.stakingPageDiv}>
                <div className={stylesFirstBlock.frameDiv}>
                    ...
                    <div className={stylesFirstBlock.titleDiv1}>
                        ...
                        <span>
                        , we require educators to stake some funds (0.0001 WMatic).
                        This prevents bad actors and content on our platform. The funds 
                        will be used to generate interest for the platform and returned 
                        if you take down your course.
                        </span>
                    </div>
                    </div>
                    <Button
