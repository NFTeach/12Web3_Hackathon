  ...
  return (
    <>
      ...
      <div className={stylesHeader.frameDiv}>
        <img className={stylesHeader.nFTeach1Icon} alt="" src="/courseCreationPages_imgs/1/NFTeach.png" />
      </div>
      {/* First Block */}
      <div className={stylesFirstBlock.courseDiv}>
        <div className={stylesFirstBlock.frameDiv}>
          <div className={stylesFirstBlock.frameDiv1}>
            <Select color="black" bg="cyan" onChange={(e) => setSelectedSection(e.target.value)}>
...
export default Course({ props.courseObjectId });
