        ...
        <div className={stylesFirstBlock.frameDiv}>
          <div className={stylesFirstBlock.frameDiv1}>
            <Menu className={stylesFirstBlock.dropdownDefaultMenu}>
              ...
              <MenuList>
                <MenuItem value='1' onChange={(e) => setSelectedSection(e.target.value)}>{courseSection1?.sectionName}</MenuItem>
                <MenuItem value='2' onChange={(e) => setSelectedSection(e.target.value)}>{courseSection2?.sectionName}</MenuItem>
                <MenuItem value='3' onChange={(e) => setSelectedSection(e.target.value)}>{courseSection3?.sectionName}</MenuItem>
              </MenuList>
            </Menu>
