    ...
    <>
      ...
      <div className={stylesFirstBlock.reviewPageDiv}>
        ...
        <div className={stylesFirstBlock.frameDiv2}>
          ...
          <Button variant="solid" w="357px" colorScheme="green" onClick={onCourseInfoOpen}>
            Edit Course Info
          </Button>
        </div>
        <div className={stylesFirstBlock.frameDiv8}>
          ...
          <Button variant="solid" w="357px" colorScheme="green" onClick={() => router.push("/courseCreationPage2")}>
            Edit Image
          </Button>
        </div>
        <div className={stylesFirstBlock.frameDiv11}>
          ...
          <Button variant="solid" w="366px" colorScheme="green" onClick={() => router.push("/courseCreationPage3")}>
            Edit Course Sections
          </Button>
          <Button variant="solid" w="374px" colorScheme="green" onClick={onTestEditOpen}>
            Edit Test
          </Button>
          <Button variant="solid" w="378px" colorScheme="green" onClick={() => router.push("/courseStaking")}>
