...
const courseStaking = () => {
    ...
    //         contractAbi: NFTEACH_ERC20_CONTRACT_ABI,
    //     };

    //     const approve = await executeContractFunction({
    //         functionName: "approve",
    //         params: {
    //             spender: GOVERNOR_CONTRACT_ADDRESS,
    //             amount: "1000000"
    //         },
    //         ...options,
    //     });
    ...
    // };
    // console.log(GOVERNOR_CONTRACT_ADDRESS)
    
    const approveERC20 = async () => {

        executeContractFunction({
            params: {
                abi: NFTEACH_ERC20_CONTRACT_ABI,
    ...
    const stakeAndCompleteCourseCreation = async () => {
            ...
            <div className={stylesFirstBlock.stakingPageDiv}>
                <div className={stylesFirstBlock.frameDiv}>
                    ...
                    onClick={async () => {
                        ...
                        await approveERC20();
                        // await stakeAndCompleteCourseCreation();
                      }}
                    >
