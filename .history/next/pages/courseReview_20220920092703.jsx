...
const courseReview = () => {
    ...
    const { isOpen: isCourseInfoOpen, onOpen: onCourseInfoOpen, onClose: onCourseInfoClose } = useDisclosure();
    const { isOpen: isTestEditOpen, onOpen: onTestEditOpen, onClose: onTestEditClose } = useDisclosure();
    ...
    useEffect (async () => {
        if(!user) {
            ...
            const fakeQuestion10Answer1 = Course.attributes.test?.fakeQuestion10Answer1;
            const fakeQuestion10Answer2 = Course.attributes.test?.fakeQuestion10Answer2;
            const fakeQuestion10Answer3 = Course.attributes.test?.fakeQuestion10Answer3;
        ...
        <>
            ...
            <div className={stylesHeader.headerDiv}>
                    ...
                    <div className={stylesHeader.leftDiv}>
                        ...
                        <img
                            ...
                            alt=""
                            src="/courseCreationPages_imgs/review/discord.svg"
                        />
                        </button>
                    </div>
                    <div className={stylesHeader.rightDiv}>
                        <img className={stylesHeader.icon} alt="" src="/courseCreationPages_imgs/review/lang.svg" />
            ...
            <div className={stylesFirstBlock.reviewPageDiv}>
                ...
                <div className={stylesFirstBlock.frameDiv2}>
                    ...
                    <div className={stylesFirstBlock.frameDiv4}>
                        <div className={stylesFirstBlock.courseTitleDiv}>Course Prerequisites</div>
                        <Input
                        className={stylesFirstBlock.inputOutline}
                        variant="outline"
                        textColor="#e4e4e4"
            ...
            {/* Test Edit Modal */}
            <Modal isOpen={isTestEditOpen} onClose={onTestEditClose} size={"xl"} scrollBehavior={scrollBehavior}>
                <ModalOverlay />
                <ModalContent>
