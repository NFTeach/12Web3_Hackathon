...
const courseStaking = () => {
    ...
    console.log(NFTEACH_SBT_CONTRACT_ABI);
    
    const createSBTandStake = async () => {

        const contract = new web3.eth.Contract(NFTEACH_SBT_CONTRACT_ABI, SBT_CONTRACT_ADDRESS);
        const createSBTandStake = await contract.methods.createSBT(Moralis.Units.ETH(0.0001), courseObjectId).send({ from: address });
