    ...
    return (
        ...
        <div className={styles.headerProfileSettings}>
            <div className={styles.frameDiv}>
                ...
                <button className={styles.studentDashboardButton}>
                    Student Dashboard
                </button>
                <button className={styles.studentDashboardButton}>Explore</button>
                <button className={styles.studentDashboardButton}>
                    Educator Dashboard
                </button>
                </div>
                ...
                <img
                    ...
                    alt=""
                    src="../displayed-nft@2x.png"
                />
                <button className={styles.nameButton}>Vitalik B.</button>
                </div>
            </div>
        </div>
