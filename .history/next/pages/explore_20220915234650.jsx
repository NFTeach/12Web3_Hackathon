        ...
        <>
            ...
            <div className={stylesFirstBlock.explorePageDiv}>
                ...
                <HStack spacing='100px'>
                    <Box w='250px' h='250px'>
                        <Link href={{pathname: "/course", query: {courseName: courseName[0], courseDescription: courseDescription[0], courseSection1: courseSection1, courseSection2: courseSection2[0], courseSection3: courseSection3[0], image: images[0]?.img}}}>
                            <Image 
                                borderRadius='full' 
                                boxSize='250px' 
                                src={images[0]?.img} 
