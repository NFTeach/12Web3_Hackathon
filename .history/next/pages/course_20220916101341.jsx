...
const course = (props) => {
    ...
    const [courseSection1Video, setCourseSection1Video] = useState();
    ...
    useEffect (async () => {
        setCourseSection1Video(courseSection1?.vid);
    }, [courseSection1]);
    ...
    console.log(courseSection1Video);
        ...
        <>
          <div className={stylesFirstBlock.courseDiv}>
            <div className={stylesFirstBlock.frameDiv}>
                ...
                <source src={courseSection1Video} />
                </video>
