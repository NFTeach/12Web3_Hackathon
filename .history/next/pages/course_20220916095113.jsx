...
const course = (props) => {
    ...
    console.log(courseSection1?.sectionName);
    return (
        <>
          <div className={stylesFirstBlock.courseDiv}>
            <div className={stylesFirstBlock.frameDiv}>
                ...
                <Select placeholder={`courseSection${selectedSection}?.sectionName`} variant="filled" bg="green" borderColor="green" color="white" onChange={(e) => setSelectedSection(e.target.value)}>
